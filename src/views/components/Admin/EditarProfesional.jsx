...
export default function EditarProfesional() {
  ...
  let newProfessional = {
    ...
    availableDays:
      diasHabiles.length > 0 ? diasHabiles : profesional.availableDays,
    id: profesional.id,
        ...
        <div style={{ display: "flex", justifyContent: "center" }}>
          <Form style={{ width: "60%", border: "1" }}>
            ...
            >
              <Form.Group className="mb-3" style={{ display: "flex" }}>
                <Form.Group style={{ width: "50%", marginRight: "20px" }}>
                  ...
                  <Form.Control
                    placeholder={`${profesional.firstName}`}
                ...
                <Form.Group style={{ width: "50%", marginLeft: "20px" }}>
                  ...
                  <Form.Control
                    value={lastName}
                    placeholder={`${profesional.lastName}`}
              ...
              <Form.Group className="mb-3" style={{ display: "flex" }}>
                ...
                <Form.Group style={{ width: "50%", marginLeft: "20px" }}>
                  ...
                  <Form.Control
                    placeholder={`${profesional.address}`}
              ...
              <Form.Group className="mb-3" style={{ display: "flex" }}>
                <Form.Group style={{ width: "50%", marginRight: "20px" }}>
                  ...
                  <Form.Control
                    type="number"
                    placeholder={`${profesional.phoneNumber}`}
                ...
                <Form.Group style={{ width: "50%", marginLeft: "20px" }}>
                  ...
                  <Form.Control
                    type="text"
                    placeholder={`${profesional.profileImg}`}
              ...
              <Form.Group className="mb-3" style={{ display: "flex" }}>
                <Form.Group style={{ width: "50%", marginRight: "20px" }}>
                  ...
                  <Dropdown>
                    ...
                    <Dropdown.Menu>
                      {week.map((day) => {
                        return (
                          <Dropdown.Item onClick={() => addDays(day.name)}>
                            {day.name}
                          </Dropdown.Item>
                        );
                      })}
                ...
                <Form.Group style={{ width: "50%", marginLeft: "20px" }}>
                  ...
                  {profesional.professions?.map((profesion) => {
                    return (
                      <Badge style={{ margin: "2%" }}>{profesion.name}</Badge>
                    );
                  })}
                  <br />
                  {newProfessional.professions?.map((profesion) => {
            ...
            {show ? (
              ...
              >
                <h3>Profesional Modificado con Exito</h3>
                {/* <ModalHeader closeButton>Profesional modificado con exito !</ModalHeader> */}
                {/* <ul>
                <li>Nombre : {newProfessional.firstName ? newProfessional.firstName : profesional.firstName}</li>
                  <li>Apellido : {newProfessional.lastName ? newProfessional.lastName : profesional.lastName}</li>
                  <li>Address : {newProfessional.address ? newProfessional.address : profesional.address}</li>
                  <li>email : {newProfessional.email ? newProfessional.email : profesional.email}</li>
                  <li>phoneNumber : {newProfessional.phoneNumber ? newProfessional.phoneNumber : profesional.phoneNumber}</li>
                  <li>profileImg : {newProfessional.profileImg ? newProfessional.profileImg : profesional.profileImg}</li>
                  <ul>
                    * Profesiones :
                    {newProfessional.professions?.map((p) => (
                      <li>{p}</li>
                    ))}
                  </ul>
                  <ul>
                    * Dias habiles :
                    {newProfessional.availableDays?.map((p) => (
                      <li>{p}</li>
                    ))}
                  </ul>
                </ul> */}
