...
function LogIn({ show,onClose}) {
  ...
  return (
    <Offcanvas show={show} onHide={onClose}>
        <Offcanvas.Header closeButton><Offcanvas.Title>Iniciaar sesion</Offcanvas.Title></Offcanvas.Header>
        <Offcanvas.Body style={{display:'flex',flexDirection:'column',gap:'2rem'}}>
        <Button onClick={googlelog}><Google /> Continua con Google</Button>
      <Form onSubmit={handleSubmit}>
        ...
        <Button type='submit' style={{margin:"2rem 2rem", width:"80%",}}>Logear</Button>
      </Form>
